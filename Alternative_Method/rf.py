...
def main():
    ...
    for repetition in range(repetitions):
        ...
        for fold in range(folds):
            ...
            # Xtrain, ytrain = train_data.drop(columns=['is_awarded', 'author_id','avg_pagerank']).values, train_data['is_awarded'].values
            # Xval, yval = val_data.drop(columns=['is_awarded', 'author_id','avg_pagerank']).values, val_data['is_awarded'].values
            # Xtest, ytest = test_data.drop(columns=['is_awarded', 'author_id','avg_pagerank']).values, test_data['is_awarded'].values
    ...
    data = [
        args.field, args.path, 'rf_non_val', args.lr,
